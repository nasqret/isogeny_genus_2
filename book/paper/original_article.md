...
|---|---:|---|---|
| C001: Symmetric-square function field and defining relations | [242-274, 372-380](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C002: Trace-method rewriting identity in symmetric coordinates | [349-368](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C003: Equations of the complementary component in X^(2) | [312-321, 381-386](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C004: Genus-zero base parametrization and elimination pipeline | [396-422](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C005: Squarefree normalization of sy^2=q(t) | [418-422](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C006: Divisor construction for the complementary map | [427-501](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C007: Rational interpolation of the complementary map | [503-527](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C008: Quartic discriminant factorization for the fiber product | [549-570](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C009: Smooth genus-2 model for the quartic fiber product | [559-571](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C010: Quartic map pi_g preserves the elliptic equation | [573-576](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C011: Self-fiber-product model of the quartic complement | [580-603](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
...
| C021: Degree-4 critical curve and genus-2 models | [674-676](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C022: Degree-4 complementary Weierstrass model | [677-677](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C023: Degree-4 complement is the -1 twist of Cremona 11a3 | [677-677](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C024: Arithmetic of the untwisted 11a3 curve | [677-677](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C025: Degree-4 ramification j-invariant | [677-677](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C026: Degree-5 base field and source models | [681-688](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C027: Degree-5 symmetric base quartic | [690-697](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C028: Degree-5 base curve has geometric genus zero | [698-699](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C029: Degree-5 base has no nonsingular point over Q(z) | [698-699](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C030: Degree-5 extension parametrization and complementary j-invariant | [698-701](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C031: Degree-2 family maps and target equations | [709-720](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C032: Critical-quartic j-invariant formulas for E and E' | [722-727](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C033: Quadratic-twist point identities from pi and pi' | [730-742](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | not_started (0%) | pending |
| C034: Article-wide computational claim coverage audit | [1-783](https://github.com/nasqret/isogeny_genus_2/blob/main/sources/paper.tex) | in_progress (20%) | [claims.json](https://github.com/nasqret/isogeny_genus_2/blob/main/research/data/claims.json)<br>[claim_inventory.md](https://github.com/nasqret/isogeny_genus_2/blob/main/research/reports/claim_inventory.md) |
...
$$X : \, y^2=F(x)$$ where $F\in K[x]$ has degree $5$ or $6$, and that
$E$ is given by the Weierstrass equation $$E: \, w^2=f(z),$$ where
$f(z) \in K[z]$ is monic of degree $3$. The map $\pi$ may then be
written as $$\pi(x,y)=(Z(x,y), \, W(x,y)),$$ where $Z$ and $W$ are
...
## Coordinates on $X^{(2)}$ {#section: coordinates}
...
dihedral group $D_4$, generated by $$\begin{aligned}
r \colon\;& \left|\,
\begin{array}{rcl}
...
\end{array}
\right.
\end{aligned}$$ The field $K(X^{(2)})$ is the subfield of $K(X^2)$ fixed
by $s$. In particular,
...
by the equation $$\pi(p_1)+\pi(p_2)=c,$$ where $p_1, \, p_2\in X$. The
...
of $\mathbb{P}^1$ (Remark [8](#remark: blow down){reference-type="ref"
reference="remark: blow down"}), the curve $\Phi_c$ is birational to a
...
::: {#remark: trace computations .remark}
**Remark 11**. The fiber over $c = 0$ is given by
$\pi(p_1) = -\pi(p_2)$, so in the standard form of Remark
[5](#rmk: standard form map){reference-type="ref"
reference="rmk: standard form map"}, this translates into the equations
...
complementary curve $\tilde{\Phi}_0$ are thus $$\begin{equation}
...
\end{equation}$$ In particular, these equations define an irreducible
curve.
:::
...
[5](#rmk: standard form map){reference-type="ref+Label"
reference="rmk: standard form map"}.*

*Step 2. Express the equations for the complementary curve
$\tilde{\Phi}_0$ in $X^{(2)}$ given in
[11](#remark: trace computations){reference-type="ref+Label"
reference="remark: trace computations"} in terms of the symmetric
...
([22](#algo: complementary map){reference-type="ref+Label"
reference="algo: complementary map"}).*
:::
...
[5](#rmk: standard form map){reference-type="ref+Label"
reference="rmk: standard form map"}, $\pi$ is then of the form
$(x,y) \mapsto (Z(x), \, yW(x))$.

### Step 2.

[11](#remark: trace computations){reference-type="ref+Label"
reference="remark: trace computations"} gives the equations of the
...
$p_y^2=y_1^2y_2^2=F(x_1)F(x_2)$, that is, $$\begin{eqnarray}
    p_y = \frac{s_y^2 - F_{\operatorname{sym}, +}(s_x, p_x)}{2}, \label{eq: eliminate py} \\
p_y^2 = F_{\operatorname{sym}, \cdot}(s_x, p_x). \label{eq: py2}
\end{eqnarray}$$ Thus, our model for $\tilde{\Phi}_0$ is cut out in the
four-dimensional affine space in the variables $s_x, p_x, s_y, p_y$ by
equations
[\[eq: eliminate py\]](#eq: eliminate py){reference-type="eqref"
reference="eq: eliminate py"} and
[\[eq: py2\]](#eq: py2){reference-type="eqref" reference="eq: py2"},
together with $$\begin{eqnarray}
\frac{Z(x_1)-Z(x_2)}{x_1-x_2}=0, \label{eq: P1} \\
y_1W(x_1) + y_2W(x_2)=0. \label{eq: select component}
\end{eqnarray}$$ By Step 2, we know how to express
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} and
[\[eq: select component\]](#eq: select component){reference-type="eqref"
reference="eq: select component"} in terms of $s_x, p_x, s_y, p_y$.
Next, we show that the curve defined in the $(s_x, p_x)$-plane by
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} has
geometric genus $0$.
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} and
[\[eq: select component\]](#eq: select component){reference-type="eqref"
reference="eq: select component"} as functions in
$x_1, \, x_2, \, y_1, \, y_2$, one should see them as functions in
$s_x, \, p_x, \, s_y, \, p_y$. Formally, one starts with the variety
defined by [\[eq: P1\]](#eq: P1){reference-type="eqref"
reference="eq: P1"} and
[\[eq: select component\]](#eq: select component){reference-type="eqref"
reference="eq: select component"} in $X^2$ and considers its image in
$X^{(2)}$.

Similarly, we may start with the curve defined by equation
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} in
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} in the
$(s_x, p_x)$-plane.
:::
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"}, but
rather its degree-$2$ quotient $T$, so all we can say in our setting is
that the curve in the $(x_1,x_2)$-plane defined by
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} is
hyperelliptic (usually of positive genus: see for example Lemma
[25](#lemma: critical EC){reference-type="ref"
reference="lemma: critical EC"}). Note furthermore that $Z(x)$ is
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} is of
geometric genus $0$, we can parametrize $s_x,\, p_x$ in terms of a new
variable $t$. Moreover, by
[\[eq: eliminate py\]](#eq: eliminate py){reference-type="eqref"
reference="eq: eliminate py"}, the variable $p_y$ is determined by the
others. Eliminating $s_x,\, p_x,\, p_y$ in favor of $t$ and $s_y$ in
[\[eq: py2\]](#eq: py2){reference-type="eqref" reference="eq: py2"} and
[\[eq: select component\]](#eq: select component){reference-type="eqref"
reference="eq: select component"} leaves us with two (reducible) curves
...
linear in $p_y$. Using
[\[eq: eliminate py\]](#eq: eliminate py){reference-type="eqref"
reference="eq: eliminate py"} to eliminate $p_y$, we obtain a polynomial
...
::: {#prop: complementary map .proposition}
...
non-constant map $\pi':X\to E'$ is given by $$\pi'(p) =
...
description of [18](#prop: complementary map){reference-type="ref+Label"
reference="prop: complementary map"} allows us to only take sums with
...
\end{equation}$$ which lies on the fiber $\Phi_a$ with
$a = \pi(p)+\pi(p_0)$. To get a point on the fixed fiber $\Phi_0$, we
compose [\[eq: X into J\]](#eq: X into J){reference-type="eqref"
reference="eq: X into J"} with $$\begin{equation}
    \label{eq: translation}
        (p)-(p_0) \mapsto \deg(\pi)\cdot [(p)-(p_0)] - \pi^\ast\pi_\ast[(p)-(p_0)].
    
\end{equation}$$ The point on the right-hand side of
[\[eq: translation\]](#eq: translation){reference-type="eqref"
reference="eq: translation"} lies in $\ker \pi_\ast$, which we identify
...
[\[eq: translation\]](#eq: translation){reference-type="eqref"
reference="eq: translation"} as $$\deg(\pi)(p)-\deg(\pi)(p_0)
        - \sum_{\substack{q \in X \\ \pi(q)=\pi(p)}} (q) \quad
        + \sum_{\substack{q' \in X \\ \pi(q')=\pi(p_0)}}(q').$$ Let
...
[18](#prop: complementary map){reference-type="ref+Label"
reference="prop: complementary map"}. One can avoid the computation of
the individual points $q$ in $\pi^{-1}(-\pi(p))$ by describing the full
divisor $$\begin{equation}
\label{eq: divisor on Phi0tilde}
   \Gamma_p := \sum_{\substack{q \in X \\ \pi(q)+\pi(p)=0 \\ q \neq i(p)}} ((p)+(q))
\end{equation}$$ on the curve $\tilde{\Phi}_0$ as the vanishing locus of
...
[\[eq: divisor on Phi0tilde\]](#eq: divisor on Phi0tilde){reference-type="eqref"
reference="eq: divisor on Phi0tilde"}. Note that the conditions
$\pi(q) + \pi(p)=0,\, q \neq i(p)$ simply amount to $(p)+(q)$ being a
point on $\tilde{\Phi}_0$. Thus,
[\[eq: divisor on Phi0tilde\]](#eq: divisor on Phi0tilde){reference-type="eqref"
reference="eq: divisor on Phi0tilde"} is the divisor on $\tilde{\Phi}_0$
...
$X^{(2)}$ of $$\begin{equation}
\label{eq: two coordinate axes}
    \{p\} \times X \; \cup \; X \times \{p\} \subset X^2.
\end{equation}$$ The subvariety cut out in $X^2$ by the (symmetric)
equations $$\begin{equation}
\label{eq: one point is p}
\begin{cases}
(x_1 - x(p)) (x_2 - x(p)) =0 \\ (y_1 -y(p))(y_2 -y(p))=0 %\\
%x_1y_1 + x_2y_2 = x_1(p)y_1(p) + x_2(p)y_2(p).
\end{cases}
\end{equation}$$ differs from
[\[eq: two coordinate axes\]](#eq: two coordinate axes){reference-type="eqref"
reference="eq: two coordinate axes"} only by a finite number of points:
...
[\[eq: one point is p\]](#eq: one point is p){reference-type="eqref"
reference="eq: one point is p"} to $X^{(2)}$ will meet $\tilde{\Phi}_0$
...
[\[eq: one point is p\]](#eq: one point is p){reference-type="eqref"
reference="eq: one point is p"}. Intersecting with $\tilde{\Phi}_0$
gives the desired divisor
[\[eq: divisor on Phi0tilde\]](#eq: divisor on Phi0tilde){reference-type="eqref"
reference="eq: divisor on Phi0tilde"}. This leads to the following
algorithm for the computation of $\pi'$.

::: {#algo: complementary map .algorithm}
...
3.  *The map $\tau_{-q_1} \circ \pi'$ is computable and, by
    [5](#rmk: standard form map){reference-type="ref+Label"
    reference="rmk: standard form map"}, of the form $(Z'(x), y W'(x))$.
...
## Critical values of polynomials {#subs: cv}
...
\end{align}$$ Here we assume $\mathrm{char}(K)=0$. We remark that
[\[eq: crEC\]](#eq: crEC){reference-type="eqref" reference="eq: crEC"}
...
The fiber product $$\begin{equation}
\label{eq: polynomial genus 2}
    C_g=\mathbb P^1_x\underset{\mathbb P^1_z}{\times} E_g
\end{equation}$$ has the affine model $$\begin{equation}
y^2=F(x):=\operatorname{Disc}_t\left(\frac{g(t)-g(x)}{t-x}\right).\label{eq: fp reduced}
\end{equation}$$ Indeed, let $\Delta(z)=\operatorname{Disc}_t(g(t)-z)$;
[\[eq: polynomial genus 2\]](#eq: polynomial genus 2){reference-type="eqref"
reference="eq: polynomial genus 2"} gives the equation $$\begin{align}
\label{eq: naive fp model}
    w^2=\Delta(g(x))
...
[\[eq: naive fp model\]](#eq: naive fp model){reference-type="eqref"
reference="eq: naive fp model"} to $y^2=F(x)$. This model is smooth: to
...
[\[eq: equations in the zero fiber\]](#eq: equations in the zero fiber){reference-type="eqref"
reference="eq: equations in the zero fiber"}, once
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} is
considered in $K(X^2)$ (rather than in the symmetric square):

::: {#lemma: critical EC .lemma}
**Lemma 25**. *Let $g\in K[x]$ be a quartic polynomial such that
[\[eq: crEC\]](#eq: crEC){reference-type="eqref" reference="eq: crEC"}
defines an elliptic curve, and let
$$X=C_g, \quad E=E_g, \quad \pi=\pi_g,$$ so that $Z(x)=g(x)$. Then, a
plane affine model for $E'$ is given by $$\begin{align}
...
[\[eq:self-fiber product\]](#eq:self-fiber product){reference-type="eqref"
reference="eq:self-fiber product"}. It is well-known [@Serre1992 §4.4]
...
$$P_j=\left(x_j,\frac{w}{g'(x_j)}\right)\in X(L),$$ which satisfies
...
finally get a rational map $$\Psi : D \dashrightarrow J$$ which, since
...
[25](#lemma: critical EC){reference-type="ref+Label"
reference="lemma: critical EC"} constructs the following diagram:
$$\begin{tikzcd}
...
coefficients. The equation $$\begin{align*}
        g(u)=g(t), \quad u\neq t
    
\end{align*}$$ has infinitely many solutions over $\mathbb Q(i)$, unless
...
$(a,b,c) = (3,4,5)$ yields the cover between the curves $$\begin{align*}
...
\end{align*}$$ given by $(x,y) \mapsto (Z(x), \, yW(x))$ with
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"} becomes
$$\begin{equation}
\label{eq: P1 example deg 3}
s_x - \frac{1}{5} p_x^2 + \frac{4}{5}p_x=0,
\end{equation}$$ which is clearly a curve of genus $0$ that we may
...
[\[eq: P1 example deg 3\]](#eq: P1 example deg 3){reference-type="eqref"
reference="eq: P1 example deg 3"} and
[\[eq: eliminate py\]](#eq: eliminate py){reference-type="eqref"
reference="eq: eliminate py"}, and take the GCD of the remaining
...
[17](#rmk: form of the model){reference-type="ref+Label"
reference="rmk: form of the model"}. The normalization step is trivial,
...
\label{eq: E prime example}
      E' :  y^2 = x^3 + 25x + 375.
\end{equation}$$ We verify that the $j$-invariant of $E'$ agrees with
[Kuhn]{.smallcaps}'s computations, and confirm the same for a sample of
further parameter triples $(a,b,c)$. Applying
[22](#algo: complementary map){reference-type="ref+Label"
reference="algo: complementary map"}, we find the explicit degree-$3$
...
$g(x)=x^4-8x^2+16x$, [\[eq: crEC\]](#eq: crEC){reference-type="eqref"
reference="eq: crEC"} and
[\[eq: fp reduced\]](#eq: fp reduced){reference-type="eqref"
reference="eq: fp reduced"} give models
$$E_g:-w^2=z^3 + 32z^2 - 896z + 4864, \quad C_g:-y^2=x^6 - 16x^4 + 40x^3 + 80x^2 - 288x + 304$$
for the curves of §[3.2](#subs: cv){reference-type="ref"
reference="subs: cv"}, after rescaling $w$ and $y$. Exploiting Lemma
[25](#lemma: critical EC){reference-type="ref"
reference="lemma: critical EC"}, we can compute the Weierstrass model
$$(w')^2=(z')^3-432z'-8208$$ for $E'_g$. This is the quadratic twist by
...
[27](#cor: fp){reference-type="ref" reference="cor: fp"}, as one can
...
::: {#example: degree 5 .example}
**Example 30** (Degree 5). We perform a computation analogous to that
of [28](#example: degree 3){reference-type="ref+Label"
reference="example: degree 3"}, starting from [Shaska]{.smallcaps}'s
...
[\[eq: P1\]](#eq: P1){reference-type="eqref" reference="eq: P1"}, which
gives $$\begin{align*}
...
\end{align*}$$ This again defines a curve of geometric genus $0$, which,
...
with $j(E)=j, \, j(E')=j'$. Then $$X:\ y^2=x^6+ax^4+bx^2+1$$ admits
...
Lemma [25](#lemma: critical EC){reference-type="ref"
reference="lemma: critical EC"}, the elliptic curves $E_g$ and $E'_g$
...
Assume, as in Remark [5](#rmk: standard form map){reference-type="ref"
reference="rmk: standard form map"}, that $\pi\circ i=-\pi$. We may then
write $\pi(x,y)=\bigl(Z(x),\,yW(x)\bigr)$ with $$F(x)W(x)^2 = f(Z(x)).$$
...
$$E'^{(F(t))}:\ F(t){w'}^2=h(z').$$ Specializing at $t=t_0\in K$ with
