"""Combined production acceptance benchmark for degree-31 recovery."""
...
FREY_KANI_MAP_RECOVERY_CONFIG = {
    ...
    "theta_power_sum_strategy": "row_major",
    "output_filename": "sage_degree31_optimized_recovery.json",
}
load(
    str(
        Path.cwd()
