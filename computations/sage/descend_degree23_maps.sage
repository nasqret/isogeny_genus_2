"""Descend both degree-23 maps using the general Frey-Kani engine."""
...
FREY_KANI_MAP_DESCENT_CONFIG = {
    ...
    "extension_degree": 12,
    "map_input_filename": "sage_degree23_maps.json",
    "output_filename": "sage_degree23_descended_maps.json",
