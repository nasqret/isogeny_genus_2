"""Search for and certify an irreducible degree-19 Frey-Kani graph."""
...
prime = ZZ(19)
field_order = ZZ(11743)
search = search_prime_frey_kani_curves(prime, field_order)
assert search["complete"]
assert search["admissible_traces"] == [192, -169]

entry1 = search["curves_by_trace"][ZZ(192)][0]
entry2 = search["curves_by_trace"][ZZ(-169)][0]
E1 = entry1["curve"]
E2 = entry2["curve"]
...
assert (E1.a4(), E1.a6()) == (8444, 6205)
assert (E2.a4(), E2.a6()) == (4036, 11557)
assert E1.abelian_group().invariants() == (19, 608)
assert E2.abelian_group().invariants() == (19, 627)
assert certificate["required_determinant"] == 16
assert certificate["anti_isometry_count"] == 6840
assert certificate["graph_size"] == 361
assert certificate["cm_squareclasses"] == (-7, -51)
...
result = {
    ...
    "workstream": "B020",
    "verified": True,
    "scope": "degree-19 candidate search and anti-isometry certificate",
    "field": "GF(11743)",
    "degree": int(prime),
    "admissible_traces": [
    ...
    "anti_isometry": {
        "matrix": [[int(1), int(0)], [int(0), int(16)]],
    ...
    "remaining_step": (
        "reconstruct the degree-19 quotient curve and its two maps"
    ),
}
output = root / "results" / "sage_degree19_anti_isometry.json"
