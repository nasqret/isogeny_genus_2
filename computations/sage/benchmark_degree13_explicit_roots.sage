"""Benchmark explicit finite-field roots in degree-13 map recovery."""
...
FREY_KANI_MAP_RECOVERY_CONFIG = {
    ...
    "extension_degree": 12,
    "sample_count": 34,
    "dual_isogeny_strategy": "explicit_base_field_roots",
    "output_filename": "sage_degree13_explicit_roots.json",
}
load(
    str(
        Path.cwd()
