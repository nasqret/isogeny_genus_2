...
- Degree 5: generic normalization conic and complementary `j` complete.
...
- Degree 13: anti-isometry, theta quotient, descent, and explicit genus-2
  curve complete; the two maps remain active.
